    ...
    <div className="min-h-screen bg-[#0f0d0b] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div
            className="inline-flex items-center justify-center w-[60px] h-[60px] bg-teal-500 rounded-2xl mb-4"
            style={{ boxShadow: "0 8px 32px rgba(20,184,166,0.25)" }}
          >
        ...
        {/* Card */}
        <div
          className="bg-[#161310] border border-white/[0.07] rounded-[20px] p-7"
        ...
        >
          <div className="flex items-center gap-2.5 mb-6 pb-5 border-b border-white/[0.06]">
            ...
            <div>
              <p className="text-sm font-medium text-white">Login karein</p>
              <p className="text-xs text-zinc-600">Apni credentials daalein</p>
            </div>
          </div>
          ...
          <div className="mt-5 pt-4 border-t border-white/[0.06] flex items-center gap-2">
            ...
            <span className="text-xs text-zinc-600">System active hai</span>
