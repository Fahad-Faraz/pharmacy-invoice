...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="flex h-screen bg-cream overflow-hidden">
      {/* Sidebar */}
      <aside className="w-56 bg-ink-950 flex flex-col flex-shrink-0">
        {/* Logo */}
        <div className="px-4 py-5 border-b border-ink-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-display font-bold text-cream text-sm">RxManager</p>
              <p className="text-ink-500 text-xs">Pharmacy</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-ink-800">
          <div className="flex items-center gap-2.5 px-3 py-2 mb-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-ink-500 text-xs capitalize">{user?.role}</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="sidebar-link w-full text-rose-400 hover:text-rose-300 hover:bg-rose-900/20"
          >
